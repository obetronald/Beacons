...
public class Modulo3 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sant.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                Intent inten = new Intent(Modulo3.this, Catalina.class);
                Modulo3.this.startActivity(inten);
        ...
        Cate.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                Intent cate = new Intent(Modulo3.this, Plaza.class);
                Modulo3.this.startActivity(cate);
        ...
        Morall.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                Intent btnmor = new Intent(Modulo3.this, Moral.class);
                Modulo3.this.startActivity(btnmor);
